      ...
      <form id="form1" method="POST" enctype="multipart/form-data">
            <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                        ...
                        <input type="file" name="adjunto" accept=".pdf, .doc, .docx" value="{{ $postulacion->archivo_cv }}" multiple />
                  </div>

                  @if($postulacion->archivo_cv !="")
                  <div class="form-group col-lg-6">
                        <a href="/files/{{ $postulacion-> archivo_cv }}" class="btn btn-rojo m-1" target="blank">Descargar el CV <i class="fas fa-download"></i></a>
                  </div>
                  @endif
            </div>
      </form>
