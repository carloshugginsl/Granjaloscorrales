...
<div class="panel-body">
      ...
      <form id="form1" method="POST">
            <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                        <label>Correo: *</label>
                        <input type="text" id="txtCorreo" name="txtCorreo" class="form-control" value="{{ $cliente->correo }}">
                  </div>
                  <div class="form-group col-lg-6">
                        <label>Direccion: *</label>
                        <input type="text" id="txtDomicilio" name="txtDomicilio" class="form-control" value="{{ $cliente->apellido }}">
                  </div>
                  <div class="form-group col-lg-6">
                        <label>Clave: *</label>
