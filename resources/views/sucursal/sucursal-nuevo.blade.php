      ...
      <form id="form1" method="POST" >
            <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                        ...
                        <input type="text" id="txtDomicilio" name="txtDomicilio" class="form-control" value="{{ $sucursal->domicilio }}" required>
                  </div>
                  <div class="form-group col-lg-6">
                  ...
                  <div class="form-group col-lg-6">
                        ...
                        <input type="text" id="txtLinkMapa" name="txtLinkMapa" class="form-control" value="{{ $sucursal->link_mapa }}" required>
                  </div>   
            </div>
      </form>
</div>
