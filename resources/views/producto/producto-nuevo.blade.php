      ...
      <form id="form1" method="POST" enctype="multipart/form-data">
            <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                        <label>Nombre: *</label>
                        <input type="text" id="txtNombre" name="txtNombre" class="form-control" value="{{ $producto->nombre }}">
                  </div>
                  <div class="form-group col-lg-3">
                        <label>Descripcion *</label>
                        <textarea name="txtDescripcion" id="txtDescripcion" cols="100" rows="0"></textarea>
                  </div>
                  <div class="form-group col-lg-6">
                        <label>Precio: *</label>
                        <input type="text" id="txtPrecio" name="txtPrecio" class="form-control" value="{{ $producto->precio}}">
                  </div>
                  ...
                  <div class="form-group col-lg-6">
                        <label>Imagen:</label>
                        <input type="file" id="imagen" name="imagen" class="d-block" value="{{ $producto->imagen}}" accept=".jpg, .jpeg, .png">
                  </div>
            </div>
      </form>
</div>
